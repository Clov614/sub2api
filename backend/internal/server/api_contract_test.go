		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"proxy_auto_maintenance_enabled": false,
					"proxy_auto_extract_url": "",
					"proxy_auto_extract_proxy_url": "",
					"proxy_auto_pool_low_watermark": 30,
					"proxy_auto_refill_interval_minutes": 5,
					"proxy_auto_health_check_interval_minutes": 10,
					"proxy_auto_dead_failure_threshold": 3,
					"proxy_auto_source_failure_threshold": 3,
					"proxy_auto_source_enabled": true,
					"proxy_auto_source_consecutive_failures": 0,
					"proxy_auto_source_last_error": "",
					"proxy_auto_source_last_success_at_unix": 0,
