export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      autoMaintenanceTitle: 'Proxy Pool Auto Maintenance',
      autoMaintenanceEnabled: 'Enable Auto Maintenance',
      autoExtractUrl: 'API Extract URL',
      autoExtractUrlPlaceholder: 'https://example.com/proxies',
      autoExtractProxyUrl: 'Extract Request Proxy (Optional)',
      autoExtractProxyUrlPlaceholder: 'http://user:pass@127.0.0.1:7890',
      autoPoolLowWatermark: 'Pool Low Watermark',
      autoRefillIntervalMinutes: 'Refill Interval (minutes)',
      autoHealthCheckIntervalMinutes: 'Health Check Interval (minutes)',
      autoDeadFailureThreshold: 'Dead Failure Threshold',
      autoSourceFailureThreshold: 'Source Disable Threshold',
      autoSourceEnabled: 'Source Enabled',
      autoSourceConsecutiveFailures: 'Source Consecutive Failures',
      autoSourceLastError: 'Last Source Error',
      autoSourceLastSuccessAt: 'Last Source Success Time',
      savingAutoMaintenance: 'Saving...',
      autoMaintenanceSaved: 'Auto maintenance settings saved',
      failedToLoadAutoMaintenance: 'Failed to load auto maintenance settings',
      failedToSaveAutoMaintenance: 'Failed to save auto maintenance settings',
