export default {
  ...
  admin: {
    ...
    proxies: {
      ...
      autoMaintenance: '自动维护',
      autoMaintenanceTitle: '代理池自动维护',
      autoMaintenanceEnabled: '启用自动维护',
      autoExtractUrl: 'API 提取链接',
      autoExtractUrlPlaceholder: 'https://example.com/proxies',
      autoExtractProxyUrl: '提取请求代理（可选）',
      autoExtractProxyUrlPlaceholder: 'http://user:pass@127.0.0.1:7890',
      autoPoolLowWatermark: '低水位阈值',
      autoRefillIntervalMinutes: '补池间隔（分钟）',
      autoHealthCheckIntervalMinutes: '健康检查间隔（分钟）',
      autoDeadFailureThreshold: '死连接判定失败次数',
      autoSourceFailureThreshold: '源失败禁用阈值',
      autoSourceEnabled: '源开关',
      autoSourceConsecutiveFailures: '源连续失败次数',
      autoSourceLastError: '源最近错误',
      autoSourceLastSuccessAt: '源最近成功时间',
      savingAutoMaintenance: '保存中...',
      autoMaintenanceSaved: '自动维护设置已保存',
      failedToLoadAutoMaintenance: '加载自动维护设置失败',
      failedToSaveAutoMaintenance: '保存自动维护设置失败',
